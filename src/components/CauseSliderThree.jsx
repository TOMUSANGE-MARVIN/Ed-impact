...
const CauseSliderThree = ({ programs = defaultPrograms }) => {
          ...
          <div className='col-12 col-md-8 col-xl-7'>
            <div className='section__header'>
              ...
              <h2 className='title-animation_inner'>
                Where Our <span>Programmes</span> Improve Learning Outcomes
              </h2>
            </div>
          </div>
              ...
              <div className='cause__slider swiper'>
                ...
                >
                  {[...programs, ...programs].map((item, index) => (
                    <div className='swiper-slide' key={item.id ? `${item.id}-${index}` : index}>
